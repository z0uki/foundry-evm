...
use crate::{provider::ProviderBuilder, ALCHEMY_FREE_TIER_CUPS};
...
impl EvmOpts {
    ...
    pub fn local_evm_env(&self) -> revm::primitives::Env {
        ...
        cfg.chain_id = self.env.chain_id.unwrap_or(1);
    ...
    pub fn get_fork(&self, env: revm::primitives::Env) -> Option<CreateFork> {
    ...
    pub async fn get_chain_id(&self) -> u64 {
        ...
        self.get_remote_chain_id().await.unwrap_or(1)
    }
    ...
    pub async fn get_remote_chain_id(&self) -> Option<u64> {
